...
--------------------------------------------
Real world example
> Imagine you are at Mcdonalds and you order a specific deal, lets say, "Big Mac" and they hand it over to you without *any questions* this is the example of simple factory. But there are cases when the creation logic might involve more steps. For example you want a customized Subway deal, you have several options in how your burger is made e.g what bread do you want? what types of sauces would you like? What cheese would you want? etc. In such cases builder pattern comes to the rescue.
...
```js
constructor(size, cheese = true, pepperoni = true, tomato = false) {
    // ...
}
```
